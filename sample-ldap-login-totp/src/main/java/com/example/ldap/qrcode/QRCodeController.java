...
public class QRCodeController {
    ...
    public void qrcodeImage(HttpServletResponse response) throws Exception {
        ...
        // TODO: Refactor QR Code logic

        // QR CODE information
        String data = String.format("otpauth://totp/%s?secret=%s&issuer=ExampleApp&algorithm=SHA256&digits=8&period=20",
    ...
    private void grantAuthority() {
        // TODO: Move to an User related service
